...
.. note::
   This website is NOT the official Fabric documentation. It's a fork generated
   from the same source but using the default ReadTheDocs theme. If you are looking
   for the official website, please refer to http://www.fabfile.org/.
